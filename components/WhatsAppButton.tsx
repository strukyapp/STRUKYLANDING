...
export default function WhatsAppButton() {
    ...
    return (
        <div className="fixed md:bottom-28 bottom-[calc(6.5rem+env(safe-area-inset-bottom))] right-4 md:right-8 z-[60] flex flex-col items-end gap-4 pointer-events-none">
            <a
